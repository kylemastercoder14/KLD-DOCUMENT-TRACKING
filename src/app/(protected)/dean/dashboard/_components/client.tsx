...
export const DeanDashboardClient = () => {
  ...
  useEffect(() => {
    const fetchAnalytics = async () => {
      ...
      setError(null);
      try {
        const response = await fetch("/api/dean-dashboard");
        if (!response.ok) {
  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        <Heading title="Dean Dashboard" description="Loading analytics..." />
  ...
  if (error) {
    return (
      <div className="space-y-6">
        <Heading title="Dean Dashboard" description="Analytics overview." />
  ...
  return (
    <div className="space-y-6">
      <Heading
        ...
        description="Monitor document throughput across your department."
      />
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          ...
          <div>
            ...
            <CardDescription>Recent submissions from your faculty.</CardDescription>
          </div>
          <Button
            variant="outline"
            size="sm"
            onClick={() => router.push("/instructor/designate-document")}
          >
            View All
          </Button>
          </CardHeader>
                      ...
                      <tr key={doc.id} className="border-t">
                        ...
                        <td className="px-4 py-3 text-right">
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              router.push(`/instructor/designate-document/view/${doc.id}`)
                            }
                          >
                            View
                          </Button>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Top document categories for your designation.</CardDescription>
          </CardHeader>
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 items-end">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => router.push(`/instructor/designate-document/view/${doc.id}`)}
                    >
                      Review
                    </Button>
                  </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Submission volume per instructor under your designation.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          {data.teamPerformance.length === 0 ? (
            <p className="text-sm text-muted-foreground">
              No faculty activity recorded yet for your designation.
            </p>
          ) : (
            <div className="overflow-x-auto">
