...
export const Client = () => {
  ...
  const [categorySearchMap, setCategorySearchMap] = useState<Record<string, string>>({});
  ...
  const getFilteredCategories = (designationId: string, categories: typeof activeDesignations[0]["documentCategories"]) => {
  ...
  const handleViewFile = useCallback((document: Document) => {
    router.push(`/president/designate-document/view/${document.id}`);
  }, [router]);
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
            ...
            <DropdownMenuContent align="end" className="w-80 max-h-[500px] overflow-y-auto">
              {isLoading ? (
                ...
                <div className="p-2 text-sm text-muted-foreground">
                  {designationSearch.trim() ? "No designations found" : "No designations available"}
                </div>
              ) : (
                <>
                              ...
                              <div className="p-2 border-b">
                                <div className="relative">
                                  ...
                                  <Input
                                    ...
                                    value={categorySearchMap[designation.id] || ""}
                                    onChange={(e) =>
                                      handleCategorySearchChange(designation.id, e.target.value)
                                    }
                                    className="pl-8 h-8"
                                    onClick={(e) => e.stopPropagation()}
                                    onKeyDown={(e) => e.stopPropagation()}
          ...
          <Button variant="primary" asChild>
            <Link href="/president/document-template">
