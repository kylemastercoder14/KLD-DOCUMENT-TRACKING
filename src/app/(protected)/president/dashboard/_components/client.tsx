...
export const PresidentDashboardClient = () => {
  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        <Heading title="President Dashboard" description="Loading analytics..." />
  ...
  if (error) {
    return (
      <div className="space-y-6">
        <Heading title="President Dashboard" description="Analytics overview." />
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-2">
          ...
          <Button
            variant="outline"
            size="sm"
            onClick={() => router.push("/president/designate-document")}
          >
            View All
          </Button>
          </CardHeader>
                      ...
                      <tr key={doc.id} className="border-t">
                        ...
                        <td className="px-4 py-3 text-right">
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              router.push(`/president/designate-document/view/${doc.id}`)
                            }
                          >
                            View
                          </Button>
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 items-end">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => router.push(`/president/designate-document/view/${doc.id}`)}
                    >
                      Review
                    </Button>
                  </div>
