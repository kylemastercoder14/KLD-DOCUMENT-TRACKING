...
export const InstructorDashboardClient = () => {
  ...
  if (isLoading) {
    return (
      <div className="space-y-6">
        <Heading title="Instructor Dashboard" description="Loading analytics..." />
  ...
  if (error) {
    return (
      <div className="space-y-6">
        <Heading title="Instructor Dashboard" description="Analytics overview." />
  ...
  return (
    <div className="space-y-6">
      <Heading
        ...
        description="Your documents and analytics at a glance."
      />
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Top document categories you handle.</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>Pending documents waiting on you.</CardDescription>
            </div>
