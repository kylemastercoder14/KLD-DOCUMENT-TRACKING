...
import {
  ...
  approveDocumentById,
  rejectDocumentById,
  getForwardableRecipientsForVpaa,
  forwardDocumentByIdForVpaa,
...
export const CellAction = ({
  ...
  const loadForwardOptions = useCallback(async () => {
    ...
    try {
      const options = await getForwardableRecipientsForVpaa();
  ...
  const forwardMutation = useMutation({
    mutationFn: async () =>
      forwardDocumentByIdForVpaa(data.id, {
          ...
          <div className="space-y-4 text-sm">
            ...
            <div className="space-y-2">
              ...
              {forwardOptionsLoading ? (
                ...
                <p className="text-sm text-muted-foreground">
                  No eligible recipients found. Please ensure President account exists.
                </p>
              ) : (
                <div className="space-y-2">
